function gamePanelUI(panel)
    ...
    towerLabel = uicontrol(panel.boardPanel1,'Style',...
        ...
        'Units', 'normalized','BackgroundColor', yblue,...
        'Position', [.1, .6, .4, .1], 'ForegroundColor',gray);
    ...
    function go_callback(hObject,eventdata)
        ...
        % reset 'Current Word' text and position, wbar text, and displayed
        % word
...
% Choose Matlab Function Category
    function matlabCat_callback(h,e)
        ...
        set(chooseFigure,'Units','pixels',...
            'Position',[fpos(1:2),350,300],...
            'NumberTitle','off',...
            'Name','Choose your function category!',...
            'MenuBar','none',...
            'DockControls','off',...
            'Resize','off',...
            'WindowStyle','modal')
...
% Choose Song callback
    function chooseSong_callback(h,e)
        ...
        function loadSong(h,e)
            ...
            % Display current lyrics on gamepanel
            set(panel.displayedWord,'String',panel.game.currentWord,...
                'FontSize', 13, 'Position', [.1 .48 .8 .12]);
...
% Reset button callback
    function reset_callback(hObject,eventdata)
        ...
        % reset 'Current Word' text and position, wbarText and displayed
        % word
        set(currentText,'String','Current Word',...
            'Position', [.1 .65 .8 .05],'Visible','on');
        set(wBarText,'Style',...
...
%Score History callback
    function pb_callback(hObject, eventdata)
        pbPlotFig=figure('Name','Score History',...
            'Toolbar','none',...
            'Menubar','none',...
            'NumberTitle','off');
        
        % create 2x2 subplots of score history in various game modes
        plot1 = subplot(2,2,1);
